    ...
    <section class="min-h-screen">
        <section id="home" class="md:mb-[100px] mb-14">
            <div class="relative h-screen bg-fixed bg-center bg-cover"
                ...
                <div class="relative flex flex-col items-center justify-center h-screen text-center text-white mx-5">
                    <div>
                        <h1 class="text-4xl font-bold md:text-6xl">Find the Government Contact <br> Instantly and
                            Effortlessly
                        </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <p class="mt-6 text-sm md:text-xl text-justify">Discover the fastest way to find the right connections.
                        Our intuitive contact directory simplifies your search, offering instant access to trusted
                        colleagues
                        and work divisions. Experience seamless navigation and effortless communication, all in one place.
                    </p>
                    <button
                        class="mt-6 w-full h-12 md:w-32 md:h-14 rounded-lg text-sm md:text-xl bg-blue-500 hover:bg-blue-600 text-white">
                        More info
                    </button>
                </div>
            </div>
        ...
        <section id="service" class="container mx-auto px-5 md:mb-[100px] mb-14">
            <div>
                ...
                <p class="mt-3 text-sm md:text-xl md:mt-5 text-center mb-10">Discover how Quick Connect simplifies your
                    contact
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 justify-center items-center">
                    <div
                        class="bg-white border border-gray-200 rounded-lg p-6 shadow-lg hover:shadow-2xl transition-shadow">
                        ...
                        <p class="mt-3 text-sm md:text-xl text-center font-light">
                            Instantly find the contact you need with our powerful search engine, saving your time and
                            effort.
                        </p>
                    </div>
                    <div
        ...
        <section id="faq" class="container mx-auto px-5 mb-10">
            <div class="mx-auto">
                ...
                <p class="mt-3 text-sm md:text-xl md:mt-5 text-center mb-10">Find answers to common questions about our
                    services
                    and information.</p>
                <div class="w-full">
                    <ul class="space-y-4">
                        ...
                        <li>
                            <button
                                class="relative flex gap-2 items-center w-full py-4 md:py-5 text-left border-t border-base-content/10 md:text-lg"
                                aria-expanded="false" onclick="toggleFAQ(this)">
                                <span class="flex-1 text-sm md:text-xl font-semibold">Is my contact information
                                    secure?</span>
                                <i
                                    class="fas fa-plus w-4 h-4 ml-auto transition-transform duration-300 ease-out fa-rotate-90"></i>
                            </button>
                        ...
                        <li>
                            <button
                                class="relative flex gap-2 items-center w-full py-4 md:py-5 text-left border-t border-base-content/10 md:text-lg"
                                aria-expanded="false" onclick="toggleFAQ(this)">
                                <span class="flex-1 text-sm md:text-xl font-semibold">Can I save and manage my
                                    contacts?</span>
                                <i
                                    class="fas fa-plus w-4 h-4 ml-auto transition-transform duration-300 ease-out fa-rotate-90"></i>
                            </button>
